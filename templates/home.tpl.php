    ...
    <div class="page">
        ...
        <div class="container-sub">
            <div class="container-content center-h order-reverse">
                ...
                <div class="container-text">
                    ...
                    <p class="header-content text-align-left fade-left paused">Open to all River Valley High School students, you can
                        participate individually or in teams of up to four members. Feel free to choose your teammates
                        or opt for random assignment.</p>
                </div>
            </div>
        </div>
        ...
        <div class="container-sub">
            <div class="container-content center-h">
                ...
                <div class="container-text">
                    ...
                    <p class="header-content text-align-right fade-right paused">The game jam runs from December 1st to 31st, coinciding
        ...
        <div class="container-sub">
            <div class="container-content center-h order-reverse">
                ...
                <div class="container-text">
                    ...
                    <p class="header-content text-align-left fade-left paused">The game jam features one main topic, along with three
                        optional sub-topics, which will boost your score.</p>
                </div>
            </div>
        </div>
        <div class="spacer"></div>
            ...
            <div class="container-content center-h">
                ...
                <div class="container-text">
                    ...
                    <p class="header-content text-align-right fade-right paused">If you're stumped by the main theme, you may choose to
                        focus solely on the sub-topics, but be aware this will result in a lower score.</p>
                </div>
            </div>
        </div>
        <div class="spacer"></div>
        <div class="container-sub">
            <p class="header-content text-align-center text-solo center-h fade-top paused">The game's theme will be announced at the
                start of the competition on December 1st, via this website and social media.</p>
        ...
        <div class="container-sub">
            <div class="container-content center-h order-reverse">
                ...
                <div class="container-text">
                    ...
                    <p class="header-content text-align-left fade-right paused">Participants can use any coding software or engine,
                        including AI tools like ChatGPT for coding purposes.</p>
                </div>
            </div>
        </div>
        <div class="spacer"></div>
        <div class="container-sub">
            <div class="container-content center-h">
                ...
                <div class="container-text">
                    ...
                    <p class="header-content text-align-right fade-right paused">While AI-generated assets is permissible, it must be
                        declared. We encourage you to create your own assets.</p>
                </div>
            </div>
        </div>
        <div class="spacer"></div>
            ...
            <div class="container-content center-h order-reverse">
                ...
                <div class="container-text">
                    ...
                    <p class="header-content text-align-left fade-right paused">All entries will be available for playtesting and voting
                        on our Game Jam website in January 2023; find the link in the header.</p>
                </div>
            </div>
        </div>
        <div class="spacer"></div>
        ...
        <div class="container-central center-h order-reverse">
            ...
            <p class="header-content text-align-left fade-bottom paused">Upload your game to the website before the 31st December for
        ...
        <div class="container-central center-h">
            ...
            <p class="header-content text-align-left fade-right paused">Submit 3-4 Screenshots of your game’s content, and a
                logo.<br><br>Optionally, submit a one-minute video (up to 16MB) to showcase your game's mechanics and
        ...
        <div class="container-sub">
            <div class="container-content center-h order-reverse">
                ...
                <div class="container-text">
                    ...
                    <p class="header-content text-align-left fade-left paused">Judging will be done by both the general public and RdeV
                        Exco. Be sure to vote for your favourite games!</p>
                </div>
            </div>
        </div>
        <div class="spacer"></div>
